...
export const MENU_FR: Record<string, { name: string; description: string }> = {
  // Pizza et plus
  'pizza-cheese-sm': { name: 'Pizza au Fromage — Petite', description: 'Pizza au fromage classique sur pâte maison.' },
  'pizza-cheese-md': { name: 'Pizza au Fromage — Moyenne', description: 'Pizza au fromage classique sur pâte maison.' },
  'pizza-cheese-lg': { name: 'Pizza au Fromage — Grande', description: 'Pizza au fromage classique sur pâte maison.' },
  'pizza-cheese-xl': { name: 'Pizza au Fromage — Très Grande', description: 'Pizza au fromage classique sur pâte maison.' },
  'pizza-3top-sm': { name: 'Pizza 3 Garnitures — Petite', description: 'Base fromage avec trois garnitures au choix.' },
  'pizza-3top-md': { name: 'Pizza 3 Garnitures — Moyenne', description: 'Base fromage avec trois garnitures au choix.' },
  'pizza-3top-lg': { name: 'Pizza 3 Garnitures — Grande', description: 'Base fromage avec trois garnitures au choix.' },
  'pizza-3top-xl': { name: 'Pizza 3 Garnitures — Très Grande', description: 'Base fromage avec trois garnitures au choix.' },
  'pizza-5top-sm': { name: 'Pizza 5 Garnitures — Petite', description: 'Base fromage avec cinq garnitures au choix.' },
  'pizza-5top-md': { name: 'Pizza 5 Garnitures — Moyenne', description: 'Base fromage avec cinq garnitures au choix.' },
  'pizza-5top-lg': { name: 'Pizza 5 Garnitures — Grande', description: 'Base fromage avec cinq garnitures au choix.' },
  'pizza-5top-xl': { name: 'Pizza 5 Garnitures — Très Grande', description: 'Base fromage avec cinq garnitures au choix.' },
  'pizza-chpaneer-sm': { name: 'Pizza Poulet et Paneer — Petite', description: 'Garnie de poulet tandoori et de paneer.' },
  'pizza-chpaneer-md': { name: 'Pizza Poulet et Paneer — Moyenne', description: 'Garnie de poulet tandoori et de paneer.' },
  'pizza-chpaneer-lg': { name: 'Pizza Poulet et Paneer — Grande', description: 'Garnie de poulet tandoori et de paneer.' },
  'pizza-chpaneer-xl': { name: 'Pizza Poulet et Paneer — Très Grande', description: 'Garnie de poulet tandoori et de paneer.' },
  'butter-chicken-poutine': { name: 'Poutine au Poulet au Beurre', description: 'Frites, fromage en grains, sauce et poulet au beurre.' },
  'poutine': { name: 'Poutine', description: 'Frites garnies de fromage en grains et de sauce.' },
  'chicken-wings': { name: '7 Ailes de Poulet', description: 'Sept ailes de poulet croustillantes avec trempette.' },
  'rose-sauce-pasta': { name: 'Pâtes Sauce Rosée', description: 'Pâtes crémeuses à la sauce rosée, tomates et épices.' },
  'white-sauce-pasta': { name: 'Pâtes Sauce Blanche', description: 'Pâtes crémeuses à la sauce blanche, fromage et épices.' },
  'burger-combo': { name: 'Combo Burger', description: '2 burgers aux nouilles végé + 2 boissons gazeuses.' },
  'pizza-combo-2med': { name: 'Combo Pizza', description: '2 pizzas moyennes + frites + 2 boissons gazeuses.' },
  'pizza-combo-deluxe': { name: 'Combo Pizza — Paneer ou Poulet', description: '1 pizza moyenne + poutine + ailes de poulet + 2 boissons.' },
  // Soups
